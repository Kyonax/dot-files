...
(defvar my-org-roam-capture-templates
  '(
    ...
    ("f" "New Feature Azure DevOps" plain "%[~/.brain.d/templates/NEWNodeTemplate.org]"
     :target (file+head kyo/org-roam-prompted-file "#+TITLE: ${title}\n#+DESCRIPTION: %^{Description}\n#+FILETAGS: %^{File Tags}\n#+AUTHOR: %^{Author}\n")
     :unnarrowed t)

    ("i" "New Sentinel Inspection" plain "%[~/.brain.d/templates/NEWNodeSentinelInspection.org]"
     :target (file+head kyo/org-roam-prompted-file "#+TITLE: Kyonax's Daily Sentinel Inspection ~ %<%d/%m/%Y> \n")
     :unnarrowed t)

    ("v" "New Invoice" plain "%[~/.brain.d/templates/NEWNodeInvoice.org]"
     :target (file+head kyo/org-roam-prompted-file "#+TITLE: Invoice ${Client Name}\n#+AUTHOR: %^{Author | Cristian D. Moreno - Kyonax}\n")
     :unnarrowed t)

    ("p" "New PBI Azure DevOps" plain "%[~/.brain.d/templates/NEWNodeProject.org]"
     :target (file+head kyo/org-roam-prompted-file "#+TITLE: ${title}\n#+DESCRIPTION: %^{Description}\n#+FILETAGS: %^{File Tags}\n#+AUTHOR: %^{Author}\n")
     :unnarrowed t)
    )
