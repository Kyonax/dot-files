...
/* Normal state */
static char normfgcolor[]                = "#4d4d4d";   // Gray text
static char normbgcolor[]                = "#000000";   // Black background
static char normbordercolor[]            = "#4d4d4d";   // Gray border
static char normfloatcolor[]             = "#333333";   // Dark float background

/* Selected state */
static char selfgcolor[]                 = "#000000";   // Black text on yellow
static char selbgcolor[]                 = "#ffd400";   // Main yellow
static char selbordercolor[]             = "#ffd400";   // Yellow border
static char selfloatcolor[]              = "#e6bf00";   // Slightly darker yellow for float

/* Title - normal */
static char titlenormfgcolor[]           = "#4d4d4d";
static char titlenormbgcolor[]           = "#000000";
static char titlenormbordercolor[]       = "#4d4d4d";
static char titlenormfloatcolor[]        = "#333333";

/* Title - selected */
static char titleselfgcolor[]            = "#545454";
static char titleselbgcolor[]            = "#303030";
static char titleselbordercolor[]        = "#ffd400";
static char titleselfloatcolor[]         = "#e6bf00";

/* Tags - normal */
static char tagsnormfgcolor[]            = "#4d4d4d";
...
static char tagsselbgcolor[]             = "#ffd400";
static char tagsselbordercolor[]         = "#ffd400";
static char tagsselfloatcolor[]          = "#e6bf00";

/* Hidden tags indicators */
static char hidnormfgcolor[]             = "#ffd400";   // Yellow for hidden (normal)
static char hidselfgcolor[]              = "#e6bf00";   // Darker yellow for hidden (selected)
static char hidnormbgcolor[]             = "#000000";
static char hidselbgcolor[]              = "#000000";

/* Urgent state */
static char urgfgcolor[]                 = "#000000";   // Black text
static char urgbgcolor[]                 = "#ff4d4d";   // Bright red background
static char urgbordercolor[]             = "#ff0000";   // Red border
static char urgfloatcolor[]              = "#993333";   // Dark red float

#if RENAMED_SCRATCHPADS_PATCH
/* Scratchpads - selected */
static char scratchselfgcolor[]          = "#000000";
static char scratchselbgcolor[]          = "#ffd400";
static char scratchselbordercolor[]      = "#ffd400";
static char scratchselfloatcolor[]       = "#e6bf00";

/* Scratchpads - normal */
static char scratchnormfgcolor[]         = "#4d4d4d";
static char scratchnormbgcolor[]         = "#000000";
static char scratchnormbordercolor[]     = "#4d4d4d";
static char scratchnormfloatcolor[]      = "#333333";
