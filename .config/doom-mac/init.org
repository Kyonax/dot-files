#+TITLE: THE INIT CONFIG FOR DOOM EMACS
#+SUBTITLE: Multi OS Support Init Config
#+AUTHOR: Cristian D. Moreno - Kyonax
#+EMAIL: kyonax.corp@gmail.com
#+DATE: November 06, 2025
#+LAST_UPDATE: November 06, 2025
#+PROJECT: dot-files
#+VERSION: v0.1
#+KEYWORDS: emacs, init, config init, docs
#+auto_tangle: t
...
* FILE-EXPORT
** MACOS
#+begin_src el :tangle (if (string= (org-babel-ref-resolve "get-os-type") "mac") "init.el" "no")
...
(doom! :input
       ...
       (org +pretty +journal +roam +dragndrop +present)               ; organize your plain life in plain text
...
#+end_src
** LINUX
#+begin_src el :tangle (if (string= (org-babel-ref-resolve "get-os-type") "linux") "init.el" "no")
Hello Fuckers!
#+end_src
